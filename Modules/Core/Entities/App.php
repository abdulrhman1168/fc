...
class App extends Model
{
     ...
     * @var array
     */
    protected $fillable = ['name', 'name_en', 'resource_name', 'icon', 'sort', 'parent_id', 'frontend_path','li_color',
                           'displayed_in_menu', 'menu_type'];
    ...
    */
    ...
    public static $unifiedResourceNames = [
        'department_services' => 'Modules\DepartmentServices\Http\Controllers'
    ];
