...
class AppsController extends UserBaseController
{
    ...
    * @param {String} name_en app name in english
    ...
    */
    public function store(Request $request)
    {
      $this->validate($request, [
          'name' => 'required',
          'name_en' => 'required',
          'resource_name' => 'required|unique:es_core_apps',
    ...
    /**
       ...
       * @apiParam {String} name_en app name in english
      ...
      public function update(Request $request, $id) {
        ...
        $this->validate($request, [
          'name' => 'required',
          'name_en' => 'required',
          'resource_name' => 'required|unique:es_core_apps,resource_name,'.$id,
          'sort' => 'required',
          'frontend_path' => 'required',
          'li_color' => 'required',
