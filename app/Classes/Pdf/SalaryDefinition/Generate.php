<?php
namespace App\Classes\Pdf\SalaryDefinition;

use \TCPDF;
use App\Classes\Pdf\SalaryDefinition\Background;
...
class Generate
{
  public static function generate($html, $isRtl, $filePath)
  {
    ...
    // set margins
    $pdf->SetTitle('Salary Definition');
    ...
    $pdf->Output('Salary_definition.pdf', 'I');
  }
}
