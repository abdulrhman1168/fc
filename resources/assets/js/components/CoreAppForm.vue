    ...
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                   <div class="form-group" v-bind:class="{ 'has-error': form.errors.has('name') }">
                     <label for="title" class="col-md-4 control-label">{{ trans('messages.name') }}</label>
                     <div class="col-md-8">
                 ...
                 <div class="col-md-6">
                    <div class="form-group" v-bind:class="{ 'has-error': form.errors.has('name_en') }">
                      <label for="title" class="col-md-4 control-label">{{ trans('messages.name_en') }}</label>
                      <div class="col-md-8">
                        <input type="text" id="name_en" name="name_en" v-model="form.name_en" class="form-control">
                        <span class="help-block" v-if="form.errors.has('name_en')">
                           <strong>{{ form.errors.get('name_en') }}</strong>
                        </span>
                      </div>
                    </div>
                  </div>
              ...
              <div class="row">
                ...
                <div class="col-md-12">
                   <div class="form-group" v-bind:class="{ 'has-error': form.errors.has('resource_name') }">
                     <label for="title" class="col-md-2 control-label">{{ trans('messages.resource_name') }}</label>
                     <div class="col-md-10">
                       <input type="text" id="resource_name" name="resource_name" v-model="form.resource_name" class="form-control">
                       <span class="help-block" v-if="form.errors.has('resource_name')">
                          <strong>{{ form.errors.get('resource_name') }}</strong>
                       </span>
                     </div>
                   </div>
                 </div>
              ...
              <div class="row">
                <div class="col-md-12">
                   <div class="form-group" v-bind:class="{ 'has-error': form.errors.has('frontend_path') }">
                     <label for="title" class="col-md-2 control-label">{{ trans('messages.frontend_path') }}</label>
                     <div class="col-md-10">
                       <input type="text" id="frontend_path" name="frontend_path" v-model="form.frontend_path" class="form-control">
                       <span class="help-block" v-if="form.errors.has('frontend_path')">
                          <strong>{{ form.errors.get('frontend_path') }}</strong>
                       </span>
                     </div>
                   </div>
                 </div>
              ...
              <div class="row">
                <div class="col-md-12">
                   <div class="form-group" v-bind:class="{ 'has-error': form.errors.has('li_color') }">
                     <label for="title" class="col-md-2 control-label">{{ trans('messages.li_color') }}</label>
                     <div class="col-md-10">
                       <input type="text" id="li_color" name="li_color" v-model="form.li_color" class="form-control">
                       <span class="help-block" v-if="form.errors.has('li_color')">
                          <strong>{{ form.errors.get('li_color') }}</strong>
                       </span>
                     </div>
                   </div>
                 </div>
              ...
              <div class="row">
                  ...
                  <div class="col-md-6">
                     <div class="form-group" v-bind:class="{ 'has-error': form.errors.has('icon') }">
                       <label for="title" class="col-md-4 control-label">{{ trans('messages.icon') }}</label>
                       <div class="col-md-8">
                         <input type="text" id="icon" name="icon" v-model="form.icon" class="form-control">
                         <span class="help-block" v-if="form.errors.has('icon')">
                            <strong>{{ form.errors.get('icon') }}</strong>
                         </span>
                       </div>
                     </div>
                   </div>
                ...
                <div class="col-md-6">
                   <div class="form-group" v-bind:class="{ 'has-error': form.errors.has('sort') }">
                     <label for="title" class="col-md-4 control-label">{{ trans('messages.sort') }}</label>
                     <div class="col-md-8">
                       <input type="number" id="sort" name="sort" v-model="form.sort" class="form-control">
                       <span class="help-block" v-if="form.errors.has('sort')">
                          <strong>{{ form.errors.get('sort') }}</strong>
                       </span>
                     </div>
                   </div>
                 </div>
              ...
              <div class="row">
                <div class="col-md-4">
                   <div class="form-group" v-bind:class="{ 'has-error': form.errors.has('displayed_in_menu') }">
                     <label for="title" class="col-md-4 control-label">{{ trans('messages.displayed_in_menu') }}</label>
                     <div class="col-md-8">
                       <input type="checkbox"  id="displayed_in_menu" name="displayed_in_menu" v-model="form.displayed_in_menu" class="form-control">

                       <span class="help-block" v-if="form.errors.has('displayed_in_menu')">
                          <strong>{{ form.errors.get('displayed_in_menu') }}</strong>
                       </span>
                     </div>
                   </div>
                 </div>
                ...
                <!-- <div class="col-md-6">
                  <vue-input v-model="form.menu_type" :label="trans('messages.menu_type')"
                             :errorMessage="form.errors.get('menu_type')" :hasError="form.errors.has('menu_type')">
                  </vue-input>
                </div> -->
        ...
        <div class="modal-footer">
          ...
          <button class="btn btn-primary"  @click="saveApp()" :disabled="isLoading">{{ trans('messages.save') }}</button>
